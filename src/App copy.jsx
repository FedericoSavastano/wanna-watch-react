...
function App() {
    ...
    useEffect(() => {
        ...
        // console.log('edit en app', isEdit, editId);
        // if (editId) {
        //     setShowForm(true);
        //     setEditRecommendation(
        //         recomendations.filter((rec) => rec.id === editId)
        //     );
        // }
    ...
    //         setRecomendations(recs);
    //         setRecomendationsLocal(recs);
    //         console.log('el local', recomendationsLocal);
    //         console.log('use effect[] de app', recs);
    //         setIsLoading(false);
    //     }
    ...
    useEffect(() => {
        let query;
        console.log('El use effect de filter query');
        async function getQuerys() {
            setIsLoading(true);
    ...
    useEffect(() => {
        ...
        //         query.eq('platform', filterQuery.platform);
        //     const { data: recs, error } = await query
        //         .order(filterQuery.order ? filterQuery.order : sortOption, {
        //             ascending: false,
        //         })
        //         .limit(1000);
        ...
        <>
            ...
            <li className='sketchy'>
                <div className='reco-button-list-top'>
                    ...
                    <span className='reco-button-list-top'>
                        <button
